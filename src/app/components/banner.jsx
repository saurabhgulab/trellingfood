...
const banner = () => {
  return (
    <div class="grid max-w-screen-xl px-4 py-4 m-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      <div class="mr-auto place-self-center lg:col-span-7">
        <h1 class="max-w-2xl mb-4 text-2xl font-extrabold tracking-tight leading-none md:text-3xl xl:text-5xl dark:text-white">
          Where creativity meets strategy to elevate your presence in the
          digital age.
        </h1>
        <p class="max-w-2xl mb-6 font-sans text-gray-800 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-7s00">
